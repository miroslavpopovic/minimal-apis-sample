...
public class ProjectsController : Controller
{
    ...
    {
        _logger.LogDebug("Getting a project with id {Id}", id);
    ...
    {
        _logger.LogDebug("Getting a page {Page} of projects with page size {Size}", page, size);
    ...
    {
        _logger.LogDebug("Deleting project with id {Id}", id);
    ...
    {
        _logger.LogDebug("Creating a new project with name {Name}", model.Name);
    ...
    {
        _logger.LogDebug("Updating project with id {Id}", id);
