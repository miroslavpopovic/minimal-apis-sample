...
public class TimeEntriesController : Controller
{
    ...
    {
        _logger.LogDebug("Getting a time entry with id {Id}", id);
    ...
    {
        _logger.LogDebug("Getting a page {Page} of time entries with page size {Size}", page, size);
    ...
    {
        _logger.LogDebug("Deleting time entries with id {Id}", id);
    ...
    {
        _logger.LogDebug("Updating time entry with id {Id}", id);
