...
public class UsersController : Controller
{
    ...
    {
        _logger.LogDebug("Getting a user with id {Id}", id);
    ...
    {
        _logger.LogDebug("Getting a page {Page} of users with page size {Size}", page, size);
    ...
    {
        _logger.LogDebug("Creating a new user with name {ModelName}", model.Name);
